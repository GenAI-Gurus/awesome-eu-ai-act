...
- [GOPAL](https://github.com/Principled-Evolution/gopal) - Apache-2.0 library of 85 OPA/Rego policies encoding AI-governance regulations as executable allow/deny checks, 29 of them mapped to EU AI Act articles. Plain Rego, so it loads into an OPA deployment you already run instead of adding a framework.
